...
function resetColor(row, sheet) {
  sheet.getRange(COLUMN_TIME_START + row + ":" + COLUMN_TIME_END + row).setBackground(COLOR_BLANK_BG);
  sheet.getRange(COLUMN_TIME_START + row + ":" + COLUMN_TIME_END + row).setFontColor(COLOR_BLANK_FONT);
  sheet.getRange(COLUMN_TIME_START + row + ":" + COLUMN_TIME_END + row).breakApart();
  sheet.getRange(COLUMN_TIME_START + row + ":" + COLUMN_TIME_END + row).setBorder(false, false, null, false, false, false, null, null);
  ...
  sheet.getRange(COLUMN_TIME_START + row + ":" + COLUMN_TIME_END + row).setValue("");
}
