...
function getMasterData() {
  ...
  if (nextShiftDate == "平日") {
    ...
    var masterDataRange = ManagementSS.getSheetByName("平日マスタ").getRange(
      2,
      1,
      lastRow - 3,
      2
  ...
  if (nextShiftDate == "土日") {
    ...
    var masterDataRange = ManagementSS.getSheetByName("土日マスタ").getRange(
      2,
      1,
      lastRow - 3,
      2
  ...
  if (nextShiftDate == "祝日") {
    ...
    var masterDataRange = ManagementSS.getSheetByName("祝日マスタ").getRange(
      2,
      1,
      lastRow - 3,
      2
  ...
  while (row <= memberCount) {
    ...
    while (rowNum <= row_last_num) {
      ...
      if (Shift === Master) {
        ...
        while (cellcheckcount < 5) {
          //5人までできる。それ以上はこの数字を変える。５なら6人目以降はスルーされる。
